...
//$s2 = "UPDATE cart SET bill_id='$val' WHERE status=3 AND owner_id='$email' AND bill_id!='$val'";
...
$sql2 = "SELECT * FROM cart WHERE status=4 AND owner_id='$email' AND bill_id='$billid'";
...
$pdf->Output();
//$sql4 = "INSERT INTO bill VALUES('$val','$count','$emp','$email','$sum','B')";

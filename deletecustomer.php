...
<br>
   ...
   <p>
       <h1 align='center' class="heading"><font color='white'>DELETE CUSTOMERS</font></h1><br>
    <br>
    <div class="gallery">
   <?php
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                if($row['email']!='admin@gmail.com') {
                    ...
                    <br><b>Phone No.:</b> ".$row['phoneno']."<br><br>
                <form method='post' name='delete'><button type='submit' name='submit' class='btn btn-primary btn-block' value='".$row['email']."'>Delete</button></form>
                </figcaption></figure> ";
                }
            }
        } else {
